...
<x-app-layout>
    ...
    <div class="py-4">
        ...
        <form method="POST" action="{{ route('poultry.providers.store') }}">
            @csrf
            <div class="space-y-5">
                ...
                <div class="bg-[#0d121f] border border-white/5 rounded-2xl overflow-hidden">
                    <div class="px-6 py-4 border-b border-white/5 flex items-center gap-3">
                        ...
                        <h3 class="text-[11px] font-black uppercase tracking-[0.2em] text-gray-400">Identidad Corporativa</h3>
                    </div>
                    <div class="p-6">
                        @include('poultry.providers.partials.form')
                    </div>
                </div>
